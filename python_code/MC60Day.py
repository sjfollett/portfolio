...
plt.grid(which="major", axis="both", color="lightslategrey", linestyle="-", linewidth=".5")
plt.title(f"{ticker} 60 Day outlook (10,000 Scenarios)")
plt.xlabel(f"Days from {datetime.date(toDate)}")
plt.ylabel("Price")
plt.show()
